...
g_ESRI_variable_1 = 'points_layer'
g_ESRI_variable_2 = 'perim_layer'
...
if __name__ == "__main__":
    ...
    point_lyr = arcpy.MakeFeatureLayer_management(points, g_ESRI_variable_1)
    perim_lyr = arcpy.MakeFeatureLayer_management(perim_points, g_ESRI_variable_2)
